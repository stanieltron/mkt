...
const { simulateRandom10000TrendModelV1 } = require("./scenario-core");
...
async function runMain() {
  ...
  for (const scenario of selectedScenarios) {
    ...
    const resultPath = writeScenarioResult({
      scenarioName: `model-v1-average-100-${scenario.key}`,
      payload: {
        model: "v1",
...
function runWorker() {
  ...
  const { summary } = simulateRandom10000TrendModelV1({
